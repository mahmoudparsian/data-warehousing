...
# From Traditional Data Warehouse to Lakehouse with DuckDB
...
**Definition**
	...
	1. A Data Lake is a centralized storage 
	   repository  that  holds  raw data in 
	   its native format 
...
### 3. Supports AI / ML workloads

### 4. No heavy ETL required

⸻

## ⚠ Challenges

### 1. Can become a Data Swamp without governance

### 2. No enforced schema

### 3. Data quality issues

### 4. Performance tuning required
...
#### 2. Decide how to use it later

#### 3. Support analytics + ML + streaming

#### 4. Enable modern Lakehouse architectures
...
### 1. Bronze/Lake → Raw CSV files 
 
### 2. Silver → Cleaned/Enriched Views 
 
### 3. Gold → Aggregated Analytics Views  
...
---
# Slide 11.1 Medallion Architecture

![](./medallion_architecture_01.webp)
